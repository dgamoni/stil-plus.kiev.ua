...
$option_store = Array(
	array(
		...
		array(
			'name' => __( 'Vacancies page caption', MISS_ADMIN_TEXTDOMAIN ),
			'desc' => __( 'Enter title for job archive page.', MISS_ADMIN_TEXTDOMAIN ),
			'id' => 'vacancy_page_caption',
			'default' => 'Archive: Vacancies',
			'type' => 'text'
		),
		...
		array(
			'name' => __( 'Albums page', MISS_ADMIN_TEXTDOMAIN ),
			'desc' => __( 'Choose one of your pages to use as a gallery page template.', MISS_ADMIN_TEXTDOMAIN ),
			'id' => 'gallery_page',
			'target' => 'page',
			'type' => 'select'
		),
		...
		array(
			'name' => __( 'Store URL', MISS_ADMIN_TEXTDOMAIN ),
			'desc' => __( 'Enter shop page URL.', MISS_ADMIN_TEXTDOMAIN ),
			'id' => 'extra_shop_url',
			'type' => 'text'
		),
