...
function miss_pagenavi($before = '', $after = '', $custom_query = array() ) {
	...
	if (!is_single()) {
		...
		$pagenavi_options['next_text'] = '<i class="fa-icon-chevron-right"></i>';
		$pagenavi_options['prev_text'] = '<i class="fa-icon-chevron-left"></i>';
		...
		if($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
			...
			$out = $before.'<div class="wp-pagenavi ' . $pagniation_type . '-more">'."\n";
